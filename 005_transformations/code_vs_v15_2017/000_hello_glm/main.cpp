...
#define W 820
#define H 820
#define WINDOW_TITLE "Transform a quad using transformation matrices"
...
int main(void)
{
	...
	myTransformMatrix = glm::rotate(myTransformMatrix, glm::radians(90.0f), glm::vec3(0.0, 0.0, 1.0));
	myTransformMatrix = glm::scale(myTransformMatrix, glm::vec3(0.5f, 0.5f, 0.5f));
